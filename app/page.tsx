        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-6 w-full">
            <div className="flex-1">
              <span className="flex items-center gap-2 text-3xl font-black text-purple-700 tracking-wide">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="w-full md:w-1/2">
            <form onSubmit={handleAskSubmit} className="flex gap-2">
              <input value={question} onChange={e=>setQuestion(e.target.value)} placeholder="Type a question in Kinyarwanda, Luganda, Swahili or English" className="flex-1 border rounded-full px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-600 placeholder:text-sm" />
        ...
        <div className="max-w-7xl mx-auto px-6 py-14">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-3 text-gray-500 text-sm max-w-sm leading-relaxed">
              Safe, private, and accurate health information for every adolescent — in Kinyarwanda, Luganda, Swahili, and English.
            </p>
